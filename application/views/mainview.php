...
<body>
	<div id="layout">
  		<div id="header">
			<div id="icon" style="margin-top:0.6%;margin-left:1.9%;">
				<img src="<?php echo base_url()?>asset/img/logo.png" height="100%"/> 
			</div>
			<div id="title">
				<div id="titletop">
  		...
  		<div id="nav" class="box">
  			<div class='hompimenu'>
    			<ul>
					...
					<li><?php //echo anchor('tes','Tes','id="tes"');?></li>
				</ul>
			</div>
  		</div>
  		<hr class="noscreen" />
		...
		?>
  		...
  		<div id="footer" class="shadow">
    		<div class="f-left">
    			...
    			?>
				<!--. All rights reserved-->
				<center>Develop by <a href="http://zainal-abidin.vv.si" target="blank">Zainal Abidin</a>
    		</div>
  		</div>
	</div>  		
</body> 
